...
<body>
	<div style="text-align: center"><font size="18">修改奖励信息</font></div>
	...
	<div style="width: 100%;text-align: right;padding-right:10px;margin-top:20px;margin-left:5px">
			<button id="insert" class="btn btn-info"  >提&nbsp;交</button>
...
$(function(){
	$.ajax({
		type : "POST",
		url : "${pageContext.request.contextPath}/selectPresent",
		dataType:'text',
		data : {info: JSON.stringify({"pid":s})},
